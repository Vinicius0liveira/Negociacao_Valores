...
CPF = int(CPF_LIMPO)
Valor_da_copmra = float(input('Digite o valor da compra: '))
...
if CPF in database:
    ...
    if database[CPF]['Categoria'] == 'vip':
        ...
        Desconto = Valor_da_copmra * 0.10
        Valor_final = Valor_da_copmra - Desconto
        print(f'O valor final da compra é: R${Valor_final:.2f}')
    else:
        print(f'O valor final da compra é: R${Valor_da_copmra:.2f}')
    ...
    if Cliente == 'comum':
        ...
        if resposta == 'sim':
            Desconto = Valor_da_copmra * 0.05
            Valor_final = Valor_da_copmra - Desconto
            print(f'Cadastro realizado com sucesso! Bem-vindo, {nome}! O valor final da compra é: R${Valor_final:.2f}')    
        elif resposta == 'não': 
            print(f'Entendido, {nome}. O valor final da compra é: R${Valor_da_copmra:.2f}')
